          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_v_card_text, { class: "pa-1" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<h1 class="text-h4 font-weight-medium mb-5"${_scopeId2}>Ordini B2B</h1>`);
                  ...
                  return [
                    createVNode("h1", { class: "text-h4 font-weight-medium mb-5" }, "Ordini B2B"),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/ordini-b2b.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=ordini-b2b.vue.mjs.map
