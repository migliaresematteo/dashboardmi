import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance as getCurrentInstance$1, toRef, inject as inject$1, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, ref, watch, onScopeDispose, computed, watchEffect, toRefs, capitalize, unref, Fragment, isVNode, Comment, warn, provide, h, defineComponent as defineComponent$1, createVNode, mergeProps, camelize, TransitionGroup, Transition, readonly, nextTick, withDirectives, resolveDirective, vShow, resolveDynamicComponent, Text, toDisplayString, markRaw, cloneVNode, Teleport, createTextVNode, withModifiers, vModelText, resolveComponent, render, defineAsyncComponent, Suspense, useSSRContext, withCtx, onErrorCaptured, onServerPrefetch, createApp } from 'file://C:/Users/matte/OneDrive/Desktop/mi-dashboardamm/Modernize-nuxtjs-free/package/node_modules/vue/index.mjs';
...
import { getContext, executeAsync } from 'file://C:/Users/matte/OneDrive/Desktop/mi-dashboardamm/Modernize-nuxtjs-free/package/node_modules/unctx/dist/index.mjs';
import { createError as createError$1, sanitizeStatusCode, appendHeader } from 'file://C:/Users/matte/OneDrive/Desktop/mi-dashboardamm/Modernize-nuxtjs-free/package/node_modules/h3/dist/index.mjs';
import { START_LOCATION, createMemoryHistory, createRouter as createRouter$1, useRoute as useRoute$2, RouterView } from 'file://C:/Users/matte/OneDrive/Desktop/mi-dashboardamm/Modernize-nuxtjs-free/package/node_modules/vue-router/dist/vue-router.node.mjs';
...
import { defu } from 'file://C:/Users/matte/OneDrive/Desktop/mi-dashboardamm/Modernize-nuxtjs-free/package/node_modules/defu/dist/defu.mjs';
import { hasProtocol, joinURL, withQuery, isScriptProtocol } from 'file://C:/Users/matte/OneDrive/Desktop/mi-dashboardamm/Modernize-nuxtjs-free/package/node_modules/ufo/dist/index.mjs';
import { ssrRenderComponent, ssrRenderAttrs, ssrRenderAttr, ssrRenderSuspense, ssrRenderVNode } from 'file://C:/Users/matte/OneDrive/Desktop/mi-dashboardamm/Modernize-nuxtjs-free/package/node_modules/vue/server-renderer/index.mjs';
import { p as publicAssetsURL, u as useHead$1, h as headSymbol } from '../_/renderer.mjs';
...
const _routes = [
  ...
  },
  {
    name: "ordini-b2b",
    path: "/ordini-b2b",
    component: () => import('./ordini-b2b.vue.mjs')
  },
  {
    name: "consegne-cap",
    path: "/consegne-cap",
    component: () => import('./consegne-cap.vue.mjs')
  },
  {
    name: "auth-Register",
    path: "/auth/Register",
  ...
  },
  {
    name: "consegne-rider",
    path: "/consegne-rider",
    component: () => import('./consegne-rider.vue.mjs')
  },
  {
    name: "ordini-mensili",
    path: "/ordini-mensili",
    component: () => import('./ordini-mensili.vue.mjs')
  },
  {
    name: "admin-dashboard",
    path: "/admin-dashboard",
    component: () => import('./admin-dashboard.vue.mjs')
  },
  {
    name: "impatto-ambientale",
    path: "/impatto-ambientale",
    component: () => import('./impatto-ambientale.vue.mjs')
  },
  {
    name: "tipologie-pagamento",
    path: "/tipologie-pagamento",
    component: () => import('./tipologie-pagamento.vue.mjs')
  }
];
              ...
              return [(_a = slots["prepend-item"]) == null ? void 0 : _a.call(slots), !displayItems.value.length && !props.hideNoData && (((_b = slots["no-data"]) == null ? void 0 : _b.call(slots)) ?? createVNode(VListItem, {
                ...
                default: (_ref4) => {
                  ...
                  return ((_a2 = slots.item) == null ? void 0 : _a2.call(slots, {
                    ...
                    title: () => {
                      var _a3, _b2;
                      return isPristine.value ? item.title : highlightResult$1(item.title, (_a3 = getMatches(item)) == null ? void 0 : _a3.title, ((_b2 = search.value) == null ? void 0 : _b2.length) ?? 0);
                    }
                  });
                }
              }), (_c = slots["append-item"]) == null ? void 0 : _c.call(slots)];
...
const plugins = [
  ...
  api_config_FBksLW_sMj9ylOYcaFjxMkdnzbYZuP_QkjbhK_7G7jU,
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_NuxtExampleLayout, _attrs, {
...
const _imports_0 = publicAssetsURL("/images/background/errorimg.svg");
...
export { _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, api as d, __nuxt_component_1 as e, useHead as f, navigateTo as n, resolveRouteObject as r, server as s, useRouter$1 as u };
